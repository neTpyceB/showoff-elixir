...
- `projects/project-10-world-scale-distributed-platform`
...
docker compose --profile test run --rm project10_test
```
...
- Current configured project CI: `project-01-cli-task-utility`, `project-02-concurrent-web-scraper`, `project-03-realtime-chat-server`, `project-04-live-dashboard-system`, `project-05-fault-tolerant-job-processing-system`, `project-06-multiplayer-game-backend`, `project-07-distributed-notification-platform`, `project-08-event-driven-saas-backend`, `project-09-realtime-collaboration-platform`, `project-10-world-scale-distributed-platform`.
